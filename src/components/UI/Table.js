                 ...
                 onMouseEnter={mouseIn} onMouseLeave={mouseOut}>
                    ...
                    { mode === 'read' ?
                        <span className={classes.tab} ref={tabRef}>
                            ...
                            &nbsp;
                            <span className={classes.tabBtn} onClick={()=>{setMode('update')}}>수정</span>
                            &nbsp;
                            <span className={classes.tabBtn} onClick={()=>{deleteTable(table.id)}}>삭제</span>
                        </span>
                        :
                        <span className={classes.tab} ref={tabRef}>
                            ...
                            &nbsp;
                            <span className={classes.tabBtn} onClick={()=>{setMode('read')}}>완료</span>
                        </span>
                    }
            </div>
            <div>
                                ...
                                return <tr key={i}>
                                    { content.map((data, j)=>{
                                        return (<td key={j}><input defaultValue={data} style={{
                                            ...
                                            updateTable({id:table.id, type:"content", column:column, i:j, value:e.target.value})                                        
                                        }}></input></td>)
                                    }) }
                                </tr>
                            })
